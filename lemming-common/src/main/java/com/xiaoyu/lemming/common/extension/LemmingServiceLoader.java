 ...
 *
 */
package com.xiaoyu.lemming.common.extension;
 ...
 * @param <S>
 */
public final class LemmingServiceLoader<S> implements Iterable<S> {
    ...
    private LemmingServiceLoader(Class<S> svc, ClassLoader cl) {
     ...
     */
    public static <S> LemmingServiceLoader<S> load(Class<S> service,
            ClassLoader loader) {
        return new LemmingServiceLoader<>(service, loader);
    }
    ...
    public static <S> LemmingServiceLoader<S> load(Class<S> service) {
        ...
        return LemmingServiceLoader.load(service, cl);
    }
     ...
     * @return A new service loader
     */
    public static <S> LemmingServiceLoader<S> loadInstalled(Class<S> service) {
        ...
        return LemmingServiceLoader.load(service, prev);
    }
