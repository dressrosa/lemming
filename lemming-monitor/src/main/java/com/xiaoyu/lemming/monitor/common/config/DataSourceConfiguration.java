...
@Configuration
@MapperScan("com.xiaoyu.lemming.monitor.dao")
public class DataSourceConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        // 设置别名包
        factory.setTypeAliasesPackage("com.xiaoyu.lemming.monitor.dao");
        final ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        // 设置mapper映射路径
        factory.setMapperLocations(resolver.getResources("mappers/*Mapper.xml"));
        // 获取mybatis.xml
